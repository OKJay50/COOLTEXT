  ...
  return {
    ...
    plugins: [
      ...
      new WebpackPwaManifest({
        name: 'Your PWA Text Editor',      // Full name of the PWA
        ...
        icons: [
          {
            src: path.resolve('src/images/icon.png'), // Icon path
      ...
      new InjectManifest({
        swSrc: './src/service-worker.js',  // Source service worker script
        swDest: 'service-worker.js',       // Output service worker script
      }),
    ],

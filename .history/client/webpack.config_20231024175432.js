  ...
  return {
    ...
    plugins: [
      ...
      new WebpackPwaManifest({
        ...
        start_url: '/',
        publicPath: './',                   // Start URL when the app is launched
        icons: [
          {
            src: path.resolve('src/images/logo.png'), // Icon path
            sizes: [96, 128, 192, 256, 384, 512],
            destination: path.join('assets', 'icons'),  // Icon sizes
          },
        ],
      }),
        ...
        },
        {
          ...
          use: {
            ...
            options: {
              ...
              plugins: ['@babel/plugin-proposal-object-rest-spread', '@babel/transform-runtime'], // Babel presets
            },
          },
        },
      ],
